...
%% ==============================
\section{Analyse des Frameworks}
%% ==============================
\label{ch:Analyse:sec:FrameworkAnalyse}

\subsection{Build-System}
\label{ch:Analys:sec:FrameworkAnalyse:sub:BuildSystem}

Da FRR CMake zum Kompilieren der Quelldateien benutzt, sollte das Tool aus Kompatibilitätsgründen auch für die Erweiterung der Suite durch einen weiteren Protokolldaemon genutzt werden.
